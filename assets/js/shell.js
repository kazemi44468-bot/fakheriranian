...
function socialLinks(){
 if(file!=='contact.html'||document.querySelector('.fakher-social'))return;
 var ids={instagram:'',telegram:'',whatsapp:'',linkedin:'',eitaa:'',rubika:'',bale:'',soroush:'',youtube:''};
 var items=[
  ['instagram','اینستاگرام','IG','https://instagram.com/'],['telegram','تلگرام','TG','https://t.me/'],['whatsapp','واتساپ','WA','https://wa.me/'],['linkedin','لینکدین','in','https://www.linkedin.com/in/'],['eitaa','ایتا','ایتا','https://eitaa.com/'],['rubika','روبیکا','روبیکا','https://rubika.ir/'],['bale','بله','بله','https://ble.ir/'],['soroush','سروش','سروش','https://splus.ir/'],['youtube','یوتیوب','YT','https://youtube.com/@']
 ];
 var section=document.createElement('section');section.className='fakher-social section';section.innerHTML='<div class="fakher-social-inner"><div class="fakher-social-head"><div><div class="eyebrow">SOCIAL · CONTACT</div><h2>فاخر را در شبکه‌های اجتماعی دنبال کنید</h2></div><p>شناسه رسمی هر شبکه پس از تأیید نهایی در همین بخش قرار می‌گیرد؛ ساختار لینک‌ها بر اساس شناسه اختصاصی هر پلتفرم آماده شده است.</p></div><div class="social-grid"></div></div>';
 var grid=section.querySelector('.social-grid');
 items.forEach(function(x){var id=ids[x[0]],a=document.createElement('a');a.className='social-item'+(id?'':' pending');a.href=id?x[3]+encodeURIComponent(id):'#';a.target=id?'_blank':'_self';a.rel='noopener';a.setAttribute('aria-label',x[1]);a.innerHTML='<span class="social-mark">'+x[2]+'</span><span><b>'+x[1]+'</b><small>'+(id?'@'+id:'در انتظار شناسه رسمی')+'</small></span><i>↗</i>';if(!id)a.addEventListener('click',function(e){e.preventDefault()});grid.appendChild(a)});
 var faq=document.querySelector('.faq');if(faq)faq.parentNode.insertBefore(section,faq);else document.querySelector('.contact-page .main')?.appendChild(section);
 var style=document.createElement('style');style.textContent='.contact-page .contact-copy .lead{font-size:1rem;line-height:2.25}.contact-page .contact-point{font-size:.9rem}.contact-page .field label{font-size:.92rem}.contact-page .field input,.contact-page .field select,.contact-page .field textarea{font-size:.98rem;line-height:1.9}.contact-page .path-item strong{font-size:.94rem}.contact-page .path-item span{font-size:.84rem}.contact-page .path-item a{font-size:.86rem}.contact-page .info-row{font-size:.9rem}.contact-page .expect-item strong{font-size:.9rem}.contact-page .expect-item p{font-size:.84rem}.contact-page .faq-item h3{font-size:.98rem}.contact-page .faq-item p{font-size:.88rem}.fakher-social{margin-top:42px}.fakher-social-inner{padding:30px;border:1px solid rgba(45,35,25,.13);border-radius:30px 9px 30px 9px;background:rgba(255,255,255,.58);box-shadow:0 16px 42px rgba(41,40,39,.05)}.fakher-social-head{display:grid;grid-template-columns:1fr .8fr;gap:25px;align-items:end;margin-bottom:22px}.fakher-social-head h2{margin:8px 0 0;font-size:1.45rem}.fakher-social-head p{margin:0;color:#756d64;font-size:.9rem;line-height:2}.social-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px}.social-item{display:flex;align-items:center;gap:12px;padding:13px;border:1px solid rgba(45,35,25,.11);border-radius:17px;background:rgba(255,255,255,.6);text-decoration:none;color:#191715;transition:.25s}.social-item:hover:not(.pending){transform:translateY(-3px);border-color:rgba(164,123,67,.4);box-shadow:0 10px 24px rgba(41,40,39,.07)}.social-item.pending{opacity:.62;cursor:default}.social-mark{width:42px;height:42px;flex:0 0 42px;border-radius:12px;display:grid;place-items:center;border:1px solid rgba(164,123,67,.3);background:rgba(164,123,67,.08);font-size:.67rem;font-weight:800;letter-spacing:.02em;color:#8c6738}.social-item b{display:block;font-size:.9rem;margin-bottom:3px}.social-item small{display:block;color:#756d64;font-size:.72rem}.social-item i{margin-right:auto;font-style:normal;color:#a47b43;font-size:1rem}@media(max-width:900px){.fakher-social-head{grid-template-columns:1fr}.social-grid{grid-template-columns:repeat(2,1fr)}}@media(max-width:620px){.contact-page .contact-copy .lead{font-size:.94rem}.contact-page .contact-point{font-size:.82rem}.contact-page .field label{font-size:.9rem}.contact-page .field input,.contact-page .field select,.contact-page .field textarea{font-size:.94rem}.fakher-social-inner{padding:22px 18px}.fakher-social-head h2{font-size:1.25rem}.fakher-social-head p{font-size:.84rem}.social-grid{grid-template-columns:1fr}.social-item{padding:12px}.social-mark{width:40px;height:40px;flex-basis:40px}}';document.head.appendChild(style);
}
function gallery(){
...
function shell(){
 ...
 backToTop();gallery();localizeNumbers();socialLinks();
}
